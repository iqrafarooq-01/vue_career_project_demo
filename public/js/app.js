...
vue__WEBPACK_IMPORTED_MODULE_0__["default"].component('job-component', {
  ...
  methods: {
    fetchJobs: function fetchJobs() {
      ...
      if (this.selectedResort === '0') {
        axios__WEBPACK_IMPORTED_MODULE_1__["default"].get('http://127.0.0.1:8000/api/careers').then(function (response) {
          _this.jobs = response.data.jobs;
        })["catch"](function (error) {
          console.error(error);
        });
      } else {
        axios__WEBPACK_IMPORTED_MODULE_1__["default"].get("http://127.0.0.1:8000/api/careers?resort_id=".concat(this.selectedResort)).then(function (response) {
          _this.jobs = response.data.jobs;
        })["catch"](function (error) {
          console.error(error);
        });
    ...
    showJobDetail: function showJobDetail(job) {
      var _this2 = this;
      axios__WEBPACK_IMPORTED_MODULE_1__["default"].get("http://127.0.0.1:8000/api/career-detail/".concat(job.id)).then(function (response) {
        _this2.jobDetail = response.data.job;
        _this2.showJob = true;
      })["catch"](function (error) {
        console.error(error);
      });
    ...
    submitApplication: function submitApplication() {
      ...
      var fileInput = this.$refs.resume;
      formData.append('resume', fileInput.files[0]);
      axios__WEBPACK_IMPORTED_MODULE_1__["default"].post('http://127.0.0.1:8000/api/career/applytojob', formData).then(function (response) {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkvue_career_demo_project"] = self["webpackChunkvue_career_demo_project"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["public/css/app"], () => (__webpack_require__("./src/assets/js/app.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["public/css/app"], () => (__webpack_require__("./src/assets/sass/app.scss")))
